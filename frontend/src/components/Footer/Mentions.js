...
<p>Hippolythe, soucieux des droits des individus, notamment au regard des traitements automatisés,
...
d’actions à la disposition des individus afin qu’ils puissent au mieux exercer leurs droits. Pour toute
information complémentaire sur la protection des données personnelles, nous vous invitons à
consulter le site : www.cnil.fr</p>

<p>La poursuite de la navigation sur ce site vaut acceptation sans réserve des dispositions et
conditions d'utilisation qui suivent. Vous acceptez l'utilisation de cookies et autres traceurs. La
version actuellement en ligne de ces conditions d'utilisation est la seule opposable pendant toute
la durée d'utilisation du site et jusqu'à ce qu'une nouvelle version la remplace.</p>
...
éléments, y compris les applications informatiques, sans l'accord préalable et écrit de l'éditeur,
sont strictement interdites. Le fait pour l'éditeur de ne pas engager de procédure dès la prise de
...
contravention avec les lois nationales ou internationales, ou avec les règles de la
Nétiquette ;
...
notamment d'attaques virales par Internet. Vous êtes par ailleurs seul responsable des sites et
données que vous consultez.
...
action contre lui de ce fait. Si l'éditeur venait à faire l'objet d'une procédure amiable ou judiciaire à
raison de votre utilisation du site, il pourra se retourner contre vous pour obtenir l'indemnisation de
tous les préjudices, sommes, condamnations et frais qui pourraient découler de cette procédure.</p>
<h2>ARTICLE 6 : LIENS HYPERTEXTES</h2>
<p>La mise en place par les utilisateurs de tous liens hypertextes vers tout ou partie du site
 est autorisée par l'éditeur. Tout lien devra être retiré sur simple demande de l'éditeur. Toute
information accessible via un lien vers d'autres sites n'est pas sous le contrôle de l'éditeur qui
décline toute responsabilité quant à leur contenu.</p>
<h2>ARTICLE 7 : COLLECTE DE DONNÉES</h2>
<p>Vos données sont collectées par Hippolythe.
...
commandes. Elles sont enregistrées dans le fichier de clients de l'éditeur et le fichier ainsi élaboré
à partir de données à caractère personnel est déclaré auprès de la CNIL.</p>
<h2>ARTICLE 8 : DROIT D’ACCÈS, DE RECTIFICATION ET DE DÉRÉFÉRENCEMENT DE VOS DONNÉES</h2>
<p>Chaque personne dispose d’un droit d’accès, de rectification et d’opposition à ses données
...
sans que vous ayez à donner votre autorisation.
En cas d'infraction de tout type, pour lesquelles les parties seraient mises en cause, et pour
lesquelles les autorités judiciciaires auraient besoin d'avoir connaissance des informations
recueillies, ces dernières seront alors nécessairement communiquées à ces autorités sur leur
demande expresse et motivée, et ne bénéficieront plus des dispositions relatives à la protection
des données personnelles.
Lorsque certaines informations sont obligatoires pour accéder à des fonctionnalités spécifiques du
site, l'éditeur indiquera ce caractère obligatoire au moment de la saisie des données.</p>
<h2>ARTICLE 10 : NEWSLETTERS</h2>
<p>Vous êtes susceptible de recevoir des newsletters. Si vous ne le souhaitez pas, veuillez cliquer sur
le lien suivant désinscription de la newletter
...
courrier électronique, de l'installation ou de l'utilisation d'un logiciel ou d'une application mobile et
ce quel que soit le type de terminal utilisé (source : www.cnil.fr/fr/cookies-traceurs-que-dit-la-loi).
En naviguant sur ce site, des « cookies » émanant de la société responsable du site concerné et/
ou des sociétés tiers pourront être déposés sur votre terminal.
Lors de la première navigation sur ce site, une bannière explicative sur l’utilisation des « cookies »
apparaîtra. Dès lors, en poursuivant la navigation, le client et/ou prospect sera réputé informé et
avoir accepté l’utilisation desdits « cookies ». Le consentement donné sera valable pour une
période de treize (13) mois.
Toutes les informations collectées ne seront utilisées que pour suivre le volume, le type et la
configuration du trafic utilisant ce site, pour en développer la conception et l'agencement et à
d'autres fins administratives et de planification et plus généralement pour améliorer le service que
nous vous offrons.
Les cookies suivants sont présents sur ce site : Cookies d'identifiants de session.
Les cookies "identifiants de session" sont utilisés afin de garder votre session active.
Les cookies "panier d'achat" sont utilisés afin de sauvegarder votre panier lors d'une session. Leur
durée de vie est de treize mois.
Pour plus d’informations sur l’utilisation, la gestion et la suppression des « cookies », pour tout
type de navigateur, nous vous invitons à consulter le lien suivant : www.cnil.fr/fr/cookies-les-outilspour-les-maitriser.</p>
